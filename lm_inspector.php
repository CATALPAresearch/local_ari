...
$PAGE->set_url($CFG->wwwroot . '/local/ari/lm_inspector.php');
...
<script>
    function fetchUsers(){
        ...
        xmlhttp.open('GET', 'lm_get_users.php?course_id=' + cID, true);
        xmlhttp.send();
    }
    ...
    function fetchUserData(){
        ...
        xmlhttp.open('GET', 'lm_get_user_data.php?user_id=' + userID + '&course_id=' + cID + '&period=' + timePeriod + '&format=html', true);
        xmlhttp.send();
