...
define(["require", "exports"], function (require, exports) {
    ...
    var MS = /** @class */ (function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, navigator.mediaDevices.getUserMedia(this._constraints)];
                        case 1:
                            stream = _a.sent();
        ...
        MS.prototype.getStream = function () {
            if (typeof this._mediaStream === "object")
                return this._mediaStream;
            return null;
        };
        MS.prototype.getURL = function () {
            if (this._objectURL)
        ...
        MS.prototype.takeScreenshot = function () { };
        return MS;
    }());
    exports.default = MS;
});
