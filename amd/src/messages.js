...
define(["require", "exports", "core/notification", "./communication"], function (require, exports, notification_1, communication_1) {
    ...
    var SystemMessage = /** @class */ (function () {
        ...
        SystemMessage.prototype.run = function () {
            return __awaiter(this, void 0, void 0, function () {
                var response, msgNum;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, communication_1.default.webservice("sendSystemMessage", { message: this._data.message })];
                        case 1:
                            response = _a.sent();
                            msgNum = +response['messageID'];
                            if (response['result'] === true && !isNaN(msgNum) && msgNum > 0) {
                                return [2 /*return*/];
                            }
                            if (typeof response['debug'] === "string")
                                throw new Error(response['debug']);
